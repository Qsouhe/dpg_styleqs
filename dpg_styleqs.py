...
def add_image(*,route: str, 
    ...
    dpg.add_image(img, tag=tag, width=width, height=height, parent=parent, user_data={"route": route,
...
def window_loader(tag: str, tag_primary_window: str, color_loading: Tuple[int, int, int], secondary_color_loading: Tuple[int, int, int], callback):
    more.more_data.add_window_loader(tag, tag_primary_window, color_loading, secondary_color_loading, callback)
    more.execute_loader()
